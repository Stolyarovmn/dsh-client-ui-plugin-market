...
function browseRequestFrom(payload) {
	if (payload === undefined || payload === null) return { query: "", page: 1, pageSize: 20, sort: "relevance", stableOnly: false, freshnessDays: 0, tag: "", dshMetadata: "any" };
	...
	return { query: query.trim(), page, pageSize, sort, stableOnly, freshnessDays, tag, dshMetadata };
}
