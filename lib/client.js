...
`;
		...
		const zh = {
			...
			"browse.search": "搜索插件、包、仓库…", "browse.refresh": "刷新", "install": "安装", "install.confirm": "确认安装？", "installing": "安装中…", "installed": "已安装", "install.failed": "安装失败", "description.more": "…", "description.less": "收起", "browse.empty": "未找到插件", "browse.sort": "排序", "browse.sort.relevance": "相关性", "browse.sort.stars": "星标", "browse.sort.downloads": "下载量", "browse.sort.name": "名称", "browse.stableOnly": "仅稳定版", "browse.emptyHint": "启用健康的来源或尝试其他搜索。", "browse.loading": "正在加载目录…", "browse.error": "目录请求失败", "browse.results": "{count} 个结果", "copy": "复制命令", "copied": "已复制", "copy.failed": "复制失败", "install.warning": "运行此第三方安装命令前，请检查包和来源。", "readonly": "设置为只读。", "unavailable": "插件源设置不可用。", 
		};
		...
		function PluginCard({ plugin, t }) {
			...
			const descriptionLong = (plugin.description?.length ?? 0) > 140;
			return hs("article", { className: "pm-card", children: [
				...
				plugin.description ? hs("div", { children: [h("p", { className: "pm-desc", "data-clamped": !expanded && descriptionLong, children: plugin.description }), descriptionLong ? h("button", { type: "button", className: "pm-more", onClick: () => setExpanded((value) => !value), children: expanded ? t("description.less") : t("description.more") }) : null] }) : null,
				...
				command ? hs("div", { children: [
					...
					hs("div", { className: "pm-card-actions", children: [
						...
						confirmInstall ? h("button", { type: "button", className: "pm-btn", onClick: () => setConfirmInstall(false), children: "Cancel" }) : null,
