...
`;
		...
		function PluginCard({ plugin, t }) {
			...
			return hs("article", { className: "pm-card", children: [
				hs("div", { className: "pm-card-head", children: [hs("div", { children: [h("span", { className: "pm-plugin-name", children: plugin.name }), plugin.version ? h("span", { className: "pm-version", children: plugin.version }) : null] })] }),
