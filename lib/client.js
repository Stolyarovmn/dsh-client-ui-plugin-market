...
`;
		...
		function RefreshIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, "aria-hidden": true, children: [h("path", { d: "M20 11a8 8 0 1 0 2 5" }), h("path", { d: "M20 4v7h-7" })] });
		}
		function PlusIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.9, "aria-hidden": true, children: [h("path", { d: "M12 5v14" }), h("path", { d: "M5 12h14" })] });
		}
		function NetworkIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, "aria-hidden": true, children: [h("circle", { cx: 6, cy: 12, r: 2 }), h("circle", { cx: 18, cy: 6, r: 2 }), h("circle", { cx: 18, cy: 18, r: 2 }), h("path", { d: "m8 11 8-4M8 13l8 4" })] });
		}
		function ShareIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.9, "aria-hidden": true, children: [h("circle", { cx: 6, cy: 12, r: 2 }), h("circle", { cx: 18, cy: 6, r: 2 }), h("circle", { cx: 18, cy: 18, r: 2 }), h("path", { d: "m8 11 8-4M8 13l8 4" })] });
		}
		function TrashIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.9, "aria-hidden": true, children: [h("path", { d: "M4 7h16M9 4h6" }), h("path", { d: "M7 7l1 13h8l1-13" }), h("path", { d: "M10 11v5M14 11v5" })] });
		}
		function PackageIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, "aria-hidden": true, children: [h("path", { d: "m12 3 8 4.5v9L12 21l-8-4.5v-9L12 3Z" }), h("path", { d: "m4 7.5 8 4.5 8-4.5M12 12v9" })] });
		}
		function DatabaseIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, "aria-hidden": true, children: [h("ellipse", { cx: 12, cy: 5, rx: 6.5, ry: 2.5 }), h("path", { d: "M5.5 5v5c0 1.4 2.9 2.5 6.5 2.5s6.5-1.1 6.5-2.5V5M5.5 10v5c0 1.4 2.9 2.5 6.5 2.5s6.5-1.1 6.5-2.5v-5" })] });
		}
		function GridIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, "aria-hidden": true, children: [h("rect", { x: 4, y: 4, width: 6, height: 6, rx: 1 }), h("rect", { x: 14, y: 4, width: 6, height: 6, rx: 1 }), h("rect", { x: 4, y: 14, width: 6, height: 6, rx: 1 }), h("rect", { x: 14, y: 14, width: 6, height: 6, rx: 1 })] });
		}
		function LinkIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.9, "aria-hidden": true, children: [h("path", { d: "m10 14 4-4" }), h("path", { d: "m7 17-1 1a3 3 0 0 1-4-4l3-3a3 3 0 0 1 4 0M17 7l1-1a3 3 0 0 1 4 4l-3 3a3 3 0 0 1-4 0" })] });
		}
		function AlertIcon() {
			return hs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, "aria-hidden": true, children: [h("circle", { cx: 12, cy: 12, r: 9 }), h("path", { d: "M12 7v6" }), h("path", { d: "M12 17h.01" })] });
		}
		function GitHubMark() {
			...
			return hs("section", { className: "pm-add-source-panel", children: [
				hs("div", { className: "pm-section-head", children: [
					hs("div", { className: "pm-section-head-main", children: [
						h("span", { className: "pm-section-icon", children: h(PlusIcon, {}) }),
				...
				expanded ? hs("form", { className: "pm-form pm-form-redesign", onSubmit: submit, children: [
					...
					hs("div", { className: "pm-form-actions", children: [
						h("button", { className: "pm-btn pm-btn-secondary", type: "button", disabled: readOnly || busy, onClick: reset, children: t("install.cancel") }),
		...
		function NpmMark() {
			return h("svg", { viewBox: "0 0 48 20", fill: "none", "aria-hidden": true, children: [
				h("rect", { x: 1, y: 1, width: 46, height: 18, rx: 1.5, fill: "currentColor" }),
				h("path", { d: "M7 6h12v8h-4V9h-4v5H7V6Zm14 0h12v8h-4V9h-4v5h-4V6Zm14 0h7v3h-3v5h-4V6Z", fill: "#d83243" })
			] });
		}
			...
			return hs("article", { className: "pm-source", children: [
				hs("div", { className: "pm-source-head", children: [
					hs("div", { className: "pm-source-main", children: [
						...
						h("div", { className: "pm-source-summary", children: [
							hs("div", { className: "pm-source-line", children: [h("span", { className: "pm-source-name", children: source.name }), h("span", { className: "pm-type", children: source.type })] }),
					...
					hs("div", { className: "pm-source-buttons", children: [
						hs("label", { className: "pm-source-switch", title: source.enabled !== false ? t("source.enabled") : t("source.disabled"), children: [
							h("input", { type: "checkbox", checked: source.enabled !== false, disabled: readOnly || busy, onChange: () => onToggle(source.id) }),
							h("span", { className: "pm-switch-track", "aria-hidden": true }),
				...
				open ? hs("div", { className: "pm-source-details", children: [
					...
					hs("div", { className: "pm-source-url-wrap", children: [
						...
						h("button", { type: "button", className: "pm-copy-url", onClick: copyEndpoint, title: copied ? t("copied") : t("copy"), "aria-label": copied ? t("copied") : t("copy"), children: h(CopyIcon, { done: copied }) }),
					] }),
					...
					hs("div", { className: "pm-source-actions", children: [
						h("button", { type: "button", className: "pm-source-action", onClick: share, title: shared ? t("source.shared") : t("source.share"), "aria-label": shared ? t("source.shared") : t("source.share"), children: shared ? h(CopyIcon, { done: true }) : h(ShareIcon, {}) }),
			...
			return hs("section", { className: "pm-sources-view", children: [
				...
				hs("section", { className: "pm-connected-panel", children: [
					hs("div", { className: "pm-section-head pm-connected-head", children: [
						hs("div", { className: "pm-section-head-main", children: [
							h("span", { className: "pm-section-icon", children: h(NetworkIcon, {}) }),
		...
		function PluginCard({ plugin, t }) {
			...
			const compatibilityLabel = resolvedCompatibility ? `DSH ${resolvedCompatibility}`
				: dshPeers.length ? t("compat.apiPeers")
					: detailsState.status === "loading" ? t("compat.loading")
						: detailsState.status === "ready" ? t("compat.none") : "DSH ?";
			...
			return hs("article", { className: "pm-card", children: [
				hs("div", { className: "pm-card-head", children: [hs("div", { children: [
					...
					freshnessLabel ? h("span", { className: "pm-signal", title: freshnessDate, children: freshnessLabel }) : null,
				...
				plugin.description ? hs("div", { children: [h("p", { className: "pm-desc", "data-clamped": !expanded, children: plugin.description }), descriptionLong ? h("button", { type: "button", className: "pm-more", onClick: () => { const next = !expanded; setExpanded(next); if (next) void loadDetails(); }, children: expanded ? t("description.less") : t("description.more") }) : null] }) : null,
				...
				(state.data?.plugins?.length ?? 0) ? hs("div", { children: [
					hs("div", { className: "pm-browse-options", children: [
						...
						hs("div", { className: "pm-filter-row", children: [
							hs("label", { className: "pm-check", children: [h("input", { className: "pm-toggle", type: "checkbox", checked: stableOnly, onChange: (event) => changeStableOnly(event.target.checked) }), h("span", { children: t("browse.stableOnly") })] }),
					...
					hs("div", { className: "pm-pagination", children: [
						...
						hs("div", { className: "pm-page-controls", children: [
							h("button", { type: "button", className: "pm-btn", disabled: state.loading || currentPage <= 1, onClick: () => setPage(Math.max(1, currentPage - 1)), children: t("browse.prev") }),
							h("button", { type: "button", className: "pm-btn", disabled: state.loading || currentPage >= pageCount, onClick: () => setPage(Math.min(pageCount, currentPage + 1)), children: t("browse.next") }),
						] }),
					] }),
				] }) : null,
			] });
