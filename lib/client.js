...
`;
		...
		function Pagination({ page, pageCount, pageSize, setPage, setPageSize, disabled, t, showPageSize = true }) {
			...
			return hs("div", { className: "pm-pagination", children: [
				...
				showPageSize ? hs("button", { type: "button", className: "pm-page-size-control", onClick: cyclePageSize, disabled, title: `${t("browse.pageSize")}: ${pageSize}`, "aria-label": `${t("browse.pageSize")}: ${pageSize}`, children: [
		...
		function CompactFilter({ icon, label, value, onChange, children, active = false }) {
			return hs("label", { className: "pm-compact-filter", "data-active": active, title: label, children: [
				...
				h("select", { "aria-label": label, value, onChange, children }),
			] });
		}
			...
			return hs("section", { className: "pm-browse-view", children: [
				...
				(state.data?.plugins?.length ?? 0) ? hs("div", { className: "pm-browse-content", children: [
					...
					hs("div", { className: "pm-controls-row", children: [
						...
						h(CompactFilter, { icon: h(IconClockOutlineRegular, { size: 14 }), label: t("browse.freshness"), value: freshnessDays, active: freshnessDays > 0, onChange: (event) => changeFreshnessDays(event.target.value), children: [
						...
						h(CompactFilter, { icon: h(IconChecklistOutlineRegular, { size: 14 }), label: t("browse.category"), value: tag, active: Boolean(tag), onChange: (event) => changeTag(event.target.value), children: [
						...
						h(CompactFilter, { icon: h(IconCodeOutlineRegular, { size: 14 }), label: t("browse.dshMetadata"), value: dshMetadata, active: dshMetadata !== "any", onChange: (event) => changeDshMetadata(event.target.value), children: [
