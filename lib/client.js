...
`;
		...
		function apply(ctx) {
			...
			ctx.slots.inject("settings.section", () => ctx.slots.register({ name: "settings.section", id: "plugin-sources", order: 60, locale: NS, label: () => { try { return ctx.locale.bind(NS)("nav"); } catch { return "Plugin Sources"; } } }, PluginSourcesSection));
		}
