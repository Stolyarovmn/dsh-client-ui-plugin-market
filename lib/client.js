...
`;
		...
		function BrowseView({ t, state, query, setQuery, refresh }) {
			...
			return hs("section", { children: [
				...
				plugins.length ? hs("div", { children: [
